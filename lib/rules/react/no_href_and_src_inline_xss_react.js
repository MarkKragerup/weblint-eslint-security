        ...
        return {
            VariableDeclarator(node) {
                ...
                if (!!node.init.callee && node.init.callee.name === 'useState') {
                    ...
                    if (isSafeValue(initialValue, safeOriginVarsSet)) {
            ...
            CallExpression(node) {
                ...
                if (isSafeValue(newValue, safeOriginVarsSet)) {
            ...
            AssignmentExpression(node) {
                ...
                if (isSafeValue(node.right, safeOriginVarsSet)) {
            ...
            JSXIdentifier(node) {
                ...
                if (isSafeValue(propertyValueNode, safeOriginVarsSet)) return; // Property value is safe - return
