...
module.exports = {
    meta: {
        type: 'error',
        docs: {
            description: 'Disallows unescaped variables of uncertain origin from href and src values, due to the concern that they might originate from user input.',
        ...
        return {
            ...
            Identifier(node) {
                ...
                context.report({
                    ...
                    fix: function (fixer) {
                        return fixer.replaceText(node, suggestedFix);
                    },
                });
            },
        };
